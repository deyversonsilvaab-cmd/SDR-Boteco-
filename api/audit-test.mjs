...
const cases = [
  ...
  { message: "Queria o cardápio", intent: "cardapio", must: ["retirada", "entrega"], forbidden: ["saipos.com", "wa.me/5519997858351", "ifood.com", "99app.com"] },
  ...
  { message: "vaga de garçom", intent: "vaga", must: ["RH do restaurante", "análise do seu perfil", "oportunidade compatível"], forbidden: ["wa.me/5517996022567"] },
