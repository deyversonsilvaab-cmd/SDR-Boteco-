  ...
  if (!process.env.OPENAI_API_KEY) {
    if (resolved) {
      return send(res, 200, {
        ...
        messages: [{ type: "text", text: resolved.facts }]
      });
    }
